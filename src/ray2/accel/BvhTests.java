...
public class BvhTests {
    ...
    public void testBvhTreeCreation() {
        ...
        System.out.println(bvh1.root.maxBound);
        System.out.println(surfaces1[0].getMaxBound());
        System.out.println(bvh1.root.minBound);
        System.out.println(surfaces1[0].getMinBound());
